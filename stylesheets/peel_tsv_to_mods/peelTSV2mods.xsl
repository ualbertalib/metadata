<xsl:stylesheet xmlns:mods="http://www.loc.gov/mods/v3"
    ...
    <xsl:param name="doc"
        select="'../../../../local-do-not-merge/local-peel.git/IA%20Postcard%20metadata%20-%20Alberta%20Churches%20A.tsv'"/>
                            ...
                            <xsl:for-each select="$cell">
                                ...
                                <xsl:if test="$lineItems[$pos] != ''">
                                    <xsl:choose>
                                        <xsl:when test="$cellValue = 'Title'">
                                            <xsl:element name="titleInfo"
                                                ...
                                                <xsl:attribute name="lang">
                                                  <xsl:value-of
                                                  select="lower-case($lineItems[$pos + 5])"/>
                                                </xsl:attribute>
                                        ...
                                        <xsl:when test="$cellValue = 'Name'">
                                            <xsl:element name="name"
                                                ...
                                                <xsl:choose>
                                                  ...
                                                  >corporate</xsl:attribute>
                                                  </xsl:when>
                                                  <xsl:otherwise>
                                                  <xsl:attribute name="type"
                                                  >personal</xsl:attribute>
                                                  </xsl:otherwise>
                                                </xsl:choose>
                                        ...
                                        <xsl:when test="$cellValue = 'Length'">
