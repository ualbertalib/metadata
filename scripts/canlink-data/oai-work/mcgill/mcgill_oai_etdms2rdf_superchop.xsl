...
<xsl:stylesheet version="2.0" xmlns:oai="http://www.openarchives.org/OAI/2.0/" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:dc="http://purl.org/dc/elements/1.1/"
    xmlns:dcterms="http://purl.org/dc/terms/" xmlns:etdms="http://www.ndltd.org/standards/metadata/etdms/1.0/" xmlns:ual="http://terms.library.ualberta.ca/"
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    xsi:schemaLocation="http://www.openarchives.org/OAI/2.0/ http://www.openarchives.org/OAI/2.0/OAI-PMH.xsd">
    <xsl:template name="superchop1">
    ...
    <xsl:template name="superchopLast">
        ...
        <xsl:element name="ual:supervisor">
