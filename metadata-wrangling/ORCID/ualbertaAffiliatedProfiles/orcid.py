...
# Given liberal rules this script correlates 992 ORCID profiles and to ERA materials, 527 of which are exact matches. Results are 80% reliable.
# Given conservative rules, 218 profiles are matched to 272 resources.
# 
